...
class TraditionalIQADataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(TraditionalIQADataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        img1_path = os.path.join(self.all_img_path, img1_name)
        img2_path = os.path.join(self.all_img_path, img2_name)
        ref_path = os.path.join(self.all_img_path, ref_name)
